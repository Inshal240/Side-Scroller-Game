...
Level2::Level2(RenderWindow& window, SFMLDebugDraw& debugDraw, b2World* World, Score* score)
...
#pragma region GameObjectsSample
	...
	StaticPlatform ground1(textureBank["brownGround"], 125, 700 - 48, 700.0f, 0); //width 250
...
State::LevelState Level2::Update(Event gameEvent, Event previousGameEvent, Time timeSinceLastUpdateCall)
{
	//_miniView.move(1,0);
...
void Level2::Draw(RenderWindow& window, Time timeSinceLastDrawCall)
{
...
void Level2::HandleInput(Event gameEvent)
{
...
void Level2::SpreadBrickPlatforms()
{
	vector<b2Vec2> locations;
...
void Level2::UnloadLevel(){
	UnloadContent();
}


void Level2::DrawMousePosition()
{
