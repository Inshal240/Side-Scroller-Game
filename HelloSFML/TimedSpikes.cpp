...
void TimedSpikes::Update( Event gameEvent, Time dt )
{
	...
	_direction == UP ? UpCycle( elapsed ) : DownCycle( elapsed );
...
void TimedSpikes::UpCycle(int elapsed) {
...
void TimedSpikes::DownCycle(int elapsed) {
