...
void Skeleton::LoadContent()
{
	...
	_animationBank[Dead].addFrame(IntRect(0, 0, 25 - 0, 50));
	_animationBank[Dead].addFrame(IntRect(51, 0, 106 - 0, 50));
	_animationBank[Dead].addFrame(IntRect(0, 0, 0, 0));
	_animationBank[Dead].addFrame(IntRect(51, 0, 106 - 0, 50));
	_animationBank[Dead].addFrame(IntRect(0, 0, 0, 0));
	_animationBank[Dead].addFrame(IntRect(51, 0, 106 - 0, 50));
	_animationBank[Dead].addFrame(IntRect(0, 0, 0, 0));
	_animationBank[Dead].addFrame(IntRect(51, 11, 106 - 0, 50));
	_animationBank[Dead].addFrame(IntRect(0, 0, 0, 0));
	_animationBank[Dead].addFrame(IntRect(0, 0, 0, 0));
	_animationBank[Dead].addFrame(IntRect(0, 0, 0, 0));
	_animationBank[Dead].addFrame(IntRect(0, 0, 0, 0));
...
void Skeleton::handleEvent(Event gameEvent, Player& player)
{
	...
	if (playerFound && !_inAir)
	{
		...
		else if (distanceFromPlayer < 0.8)
		{
			int choice = rand() % 55;
...
void Skeleton::Update(Event gameEvent, Player& player, Time dt, Time frameTime)
{
	...
	if ( distance  < 1.2 && _state == Attack && _animatedSprite.getCurrentFrame() == 2 ) player.Damage(20); //cout << "Kirby attacking player " << endl ;
